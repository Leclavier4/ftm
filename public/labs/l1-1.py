#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Terminal // Bonjour terminal
# Fais d'abord la tache du lab, PUIS : python3 l1-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="qjbxKKGGy+s1gx/cjWNSIs5ajnLwucU="; CHK="d0ea9d42"
BRIEF='Tu dois savoir te reperer : pwd, ls, cd.'; QUESTION='Tape `whoami` dans Kali. Resultat ?'
def norm(s):
...
def main():
    print("\n  \033[96mLe Terminal\033[0m // \033[1mBonjour terminal\033[0m\n")
    print("  "+BRIEF+"\n")
