#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // La Forge // Invoque Kali
# Fais d'abord la tache du lab, PUIS : python3 l0-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="qjbxKKCC+PELnAX3vXN5F9lgjnfwuN0y"; CHK="ce5020de"
BRIEF="Ta VM Kali doit demarrer et tu dois pouvoir t'y connecter."; QUESTION='Dans un terminal Kali, tape `whoami`. Quel est le resultat ?'
def norm(s):
...
def main():
    print("\n  \033[96mLa Forge\033[0m // \033[1mInvoque Kali\033[0m\n")
    print("  "+BRIEF+"\n")
