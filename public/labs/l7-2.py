#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // L'Arene // Prends des notes
# Fais d'abord la tache du lab, PUIS : python3 l7-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="DtFvp7ocPMIhUkNpfM20uAkXZ1odX/MsGudRohgt+/484H2sqAYe"; CHK="49bfda98"
BRIEF='Documente tout, au fur et a mesure.'; QUESTION="Complete : si ce n'est pas ______, ca n'existe pas (un mot)."
def norm(s):
...
def main():
    print("\n  \033[96mL'Arene\033[0m // \033[1mPrends des notes\033[0m\n")
    print("  "+BRIEF+"\n")
