#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // La Toile // Anatomie d'une requete
# Fais d'abord la tache du lab, PUIS : python3 l5-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="W0LLawtmgttmrK/fFfbqTvcv7tG2IkbVM7jpc6oRid1paw=="; CHK="533ef0b9"
BRIEF='Tu dois savoir lire les codes de statut HTTP.'; QUESTION="Quel code HTTP signifie 'page introuvable' ?"
def norm(s):
...
def main():
    print("\n  \033[96mLa Toile\033[0m // \033[1mAnatomie d'une requete\033[0m\n")
    print("  "+BRIEF+"\n")
