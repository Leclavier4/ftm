#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Les Cables // L'annuaire secret
# Fais d'abord la tache du lab, PUIS : python3 l3-3.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="FraV/apTmgSKHbIKcSKvXCpegtDKjeq+Yg=="; CHK="c2ff1d7d"
BRIEF='Tu dois avoir resolu un nom de domaine en IP.'; QUESTION='Le DNS traduit un nom de domaine en quoi ? (deux lettres)'
def norm(s):
...
def main():
    print("\n  \033[96mLes Cables\033[0m // \033[1mL'annuaire secret\033[0m\n")
    print("  "+BRIEF+"\n")
