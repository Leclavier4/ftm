#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // L'Arene // Le rapport
# Fais d'abord la tache du lab, PUIS : python3 l7-3.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="hDwi37ynn9kuakofdhp/tZq/SJr6oiVRdmWzt9F/KnKjCwTZ"; CHK="5098484b"
BRIEF='Un test sans rapport ne sert a rien.'; QUESTION='Quel document restitue un test de securite ? (un mot)'
def norm(s):
...
def main():
    print("\n  \033[96mL'Arene\033[0m // \033[1mLe rapport\033[0m\n")
    print("  "+BRIEF+"\n")
