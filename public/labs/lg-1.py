#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Pantheon // L'epreuve finale
# Fais d'abord la tache du lab, PUIS : python3 lg-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="uVPkvsj17mpluhFYWyrKGz8Ma5US2FTZz0c="; CHK="1b3841fe"
BRIEF='Resous une box debutant de bout en bout.'; QUESTION="Cite une plateforme d'entrainement sur des box (un mot) :"
def norm(s):
...
def main():
    print("\n  \033[96mLe Pantheon\033[0m // \033[1mL'epreuve finale\033[0m\n")
    print("  "+BRIEF+"\n")
