#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // L'Atelier // Installe l'etabli
# Fais d'abord la tache du lab, PUIS : python3 l2-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="esStFCmrXDTidSY0WRkw7wlQ/C8="; CHK="399ff5fd"
BRIEF='Tu dois avoir installe VSCode sur Kali.'; QUESTION='Quelle commande, tapee dans le terminal, lance VSCode ? (un mot)'
def norm(s):
...
def main():
    print("\n  \033[96mL'Atelier\033[0m // \033[1mInstalle l'etabli\033[0m\n")
    print("  "+BRIEF+"\n")
