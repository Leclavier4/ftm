#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Les Cables // Ping le monde
# Fais d'abord la tache du lab, PUIS : python3 l3-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="lXzmvakLJMEaPz8u7liYS2fojfi1ig=="; CHK="b829cac9"
BRIEF='Tu dois avoir trouve ton IP et teste la connectivite.'; QUESTION='Quelle commande teste la connectivite (echo request) ? (un mot)'
def norm(s):
...
def main():
    print("\n  \033[96mLes Cables\033[0m // \033[1mPing le monde\033[0m\n")
    print("  "+BRIEF+"\n")
