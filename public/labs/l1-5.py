#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Terminal // Les fantomes actifs
# Fais d'abord la tache du lab, PUIS : python3 l1-5.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="R3n4DQibmZ5kOcMh9Q3qYvScGT1zG4o4+cUX"; CHK="1353952d"
BRIEF='Tu dois savoir lister et arreter un processus.'; QUESTION='Quelle commande arrete un processus via son PID ? (un mot)'
def norm(s):
...
def main():
    print("\n  \033[96mLe Terminal\033[0m // \033[1mLes fantomes actifs\033[0m\n")
    print("  "+BRIEF+"\n")
