#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // L'Atelier // Ton premier script
# Fais d'abord la tache du lab, PUIS : python3 l2-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="qt9PhAFL3N0SY1mS80Ii70sAD+e8/zEh5yRXhhjf"; CHK="21e22e93"
BRIEF='Tu dois avoir ecrit et lance un script bash.'; QUESTION="Quelle est la premiere ligne (le shebang) d'un script bash ?"
def norm(s):
...
def main():
    print("\n  \033[96mL'Atelier\033[0m // \033[1mTon premier script\033[0m\n")
    print("  "+BRIEF+"\n")
