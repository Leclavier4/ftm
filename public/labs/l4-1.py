#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Coffre // Base64 demasque
# Fais d'abord la tache du lab, PUIS : python3 l4-1.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="9acl6nQRRtsccNRZAqUrCBEFtywLnqkNVZMC9VxUCmrWng3/Yg0="; CHK="3e28f6e2"
BRIEF='Decode la chaine Base64 donnee dans le lab.'; QUESTION='Colle ici le TEXTE obtenu apres decodage Base64 :'
def norm(s):
...
def main():
    print("\n  \033[96mLe Coffre\033[0m // \033[1mBase64 demasque\033[0m\n")
    print("  "+BRIEF+"\n")
