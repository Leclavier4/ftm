#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Coffre // Le Cesar
# Fais d'abord la tache du lab, PUIS : python3 l4-3.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="DQtrH9So9sDP6qkTQBFrRf97W9PN0liqXXOfLw9d3g=="; CHK="97f4003c"
BRIEF='Dechiffre le message ROT13 du lab.'; QUESTION='Colle ici le message DECHIFFRE (ROT13) :'
def norm(s):
...
def main():
    print("\n  \033[96mLe Coffre\033[0m // \033[1mLe Cesar\033[0m\n")
    print("  "+BRIEF+"\n")
