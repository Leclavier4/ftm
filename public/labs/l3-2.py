#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Les Cables // Les portes du chateau
# Fais d'abord la tache du lab, PUIS : python3 l3-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="YKi9EmTSV2RKLspQWkdGICBSY/5ccT4uxfeBLFtw7PtSgQ=="; CHK="4f0ba8f4"
BRIEF='Tu dois avoir scanne les ports de TA machine.'; QUESTION="Quel outil scanne les ports d'une machine ? (un mot)"
def norm(s):
...
def main():
    print("\n  \033[96mLes Cables\033[0m // \033[1mLes portes du chateau\033[0m\n")
    print("  "+BRIEF+"\n")
