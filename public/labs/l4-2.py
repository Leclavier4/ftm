#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Coffre // L'empreinte
# Fais d'abord la tache du lab, PUIS : python3 l4-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="VMf80+7mtfd3QRuhfBQr4afZ1JEHca5hN/yqynEn6CVz4Mw="; CHK="24a02e5f"
BRIEF="Tu dois comprendre qu'un hash est a sens unique."; QUESTION='Un hash se dechiffre-t-il ? (oui / non)'
def norm(s):
...
def main():
    print("\n  \033[96mLe Coffre\033[0m // \033[1mL'empreinte\033[0m\n")
    print("  "+BRIEF+"\n")
