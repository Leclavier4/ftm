#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // La Toile // La cle sous le paillasson
# Fais d'abord la tache du lab, PUIS : python3 l5-4.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="wpRC99oW7z+O/ug7ZVYnDbL8dj9AcwadDg=="; CHK="1bd5f207"
BRIEF="Tu dois comprendre l'IDOR."; QUESTION="Dans un IDOR, on modifie l'____ dans l'URL (deux lettres) :"
def norm(s):
...
def main():
    print("\n  \033[96mLa Toile\033[0m // \033[1mLa cle sous le paillasson\033[0m\n")
    print("  "+BRIEF+"\n")
