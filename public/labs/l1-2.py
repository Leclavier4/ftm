#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# FTM ACADEMY // Le Terminal // Chasse au fichier
# Fais d'abord la tache du lab, PUIS : python3 l1-2.py
import hashlib, base64, unicodedata
SALT=b"ftm-academy-v1"; CT="ncGSwdaa6zDcxEd4yNuquvEbrNpaWz8="; CHK="93aa604c"
BRIEF="Tu as cache le mot 'sesame' dans note13.txt puis retrouve avec grep."; QUESTION='Quel etait le mot secret cache dans note13.txt ?'
def norm(s):
...
def main():
    print("\n  \033[96mLe Terminal\033[0m // \033[1mChasse au fichier\033[0m\n")
    print("  "+BRIEF+"\n")
